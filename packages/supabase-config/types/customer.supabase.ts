...
export type Database = {
  public: {
    Tables: {
      ...
      Sales: {
        Row: {
          AddonType: Database["public"]["Enums"]["Sale Addon Type"] | null;
          BookingType: string | null;
          created_at: string;
          ReferenceID: number | null;
          SaleAmount: number | null;
          SaleCategory:
            | Database["public"]["Enums"]["Sale Category Type"]
            | null;
          SaleID: number;
          SaleStatus: Database["public"]["Enums"]["Sale Status"] | null;
        };
        Insert: {
          AddonType?: Database["public"]["Enums"]["Sale Addon Type"] | null;
          BookingType?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "Sales_ReferenceID_fkey";
            columns: ["ReferenceID"];
            isOneToOne: false;
            referencedRelation: "Orders";
            referencedColumns: ["id"];
    ...
    Enums: {
      appVersion: "v1" | "v2";
      "Sale Addon Type": "Subscription" | "File_Recovery";
      "Sale Category Type": "booking" | "addon";
      "Sale Status": "completed" | "incomplete";
