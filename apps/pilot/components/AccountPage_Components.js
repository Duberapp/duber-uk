    ...
    <div className="mt-2 w-full min-h-32 p-2 pb-4 rounded bg-primaryBlueLight relative">
      ...
      <div className="flex items-center gap-2">
        <div
          ...
          className="flex-1 cursor-pointer flex items-center justify-between border border-primaryBlue p-2 rounded-md"
        >
        ...
        <button className="bg-primaryBlue text-white text-sm px-5 h-full py-2 borderRadius">
          Add
        </button>
      </div>
  ...
  return (
    <div className="mt-2 w-full min-h-32 p-2 pb-4 rounded bg-primaryBlueLight relative">
      ...
      <div className="flex items-center">
        <div
          onClick={() => setBrandMenu(!showBrandMenu)}
        ...
        <div
          onClick={() => setModalMenu(!showModalMenu)}
        ...
        <button className="ml-2 bg-primaryBlue text-white text-sm px-5 h-full py-2 rounded-md">
          Add
        </button>
      </div>
